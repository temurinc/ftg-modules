...
Давай я найду в Google / YouTube / DuckDuckGo / altnews / Xvideo / Xvideos2/ Pornhub / var / log / Dyno для тебя! 

Syntax:

 .lmg <поисковый запрос>

 .lmy <поисковый запрос>
 
 .lmd <поисковый запрос>
 ...
 .lmvar <название приложения heroku>

 .lmlog <название приложения heroku>
...
async def _(event):
    ...
    if response_api:
        ...
        await event.edit("Я проверю **Ютуб** специально для тебя:\n👉 [{}]({})\n`Лови ссылку, не забудь сказать спасибо! 😉` ".format(input_str,response_api.rstrip()))
